...
public class player_layout extends AppCompatActivity implements View.OnClickListener {
    private ImageView iv_cover, shangyishou, xiayishou;
    private static SeekBar sb;
    private Button back;
    private static TextView tv_progres, tv_total,starnum;
    private ImageView btn_play,star;
    ...
    private Music music;
    private TextView song_title, qingxidu, singer, text;
    ...
    public void onClick(View v) {
        ...
        star.setOnClickListener((view) -> {
            if(starto==0){
                starto=1;
                starnum.setText(this.music.getStar());
                star.setImageResource(R.drawable.dianzan_red);
            }else if(starto==1){
                starto=0;
                starnum.setText(this.music.getStar());
                star.setImageResource(R.drawable.dianzan);
            }
        });
        btn_play.setOnClickListener((view) -> {
            if (num == 0) {
                ...
                num = 1;
                String url=this.music.getUrl();
                musicControl.play(url);//传递播放链接
                animator.start();
            } else if (num == 1) {
